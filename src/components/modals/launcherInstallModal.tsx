...
export const LauncherInstallModal: VFC<LauncherInstallModalProps> = ({ closeModal, launcherOptions, serverAPI }) => {
    ...
    <ModalRoot style={{ maxWidth: '600px', height: '80vh', display: 'flex', flexDirection: 'column' }}>
        <DialogHeader>
        ...
        <DialogBody style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
            ...
            {imageUrl && (
                <img src={imageUrl} alt="Overlay" style={{ ...fadeStyle, opacity: 0.5, maxHeight: '150px', objectFit: 'contain' }} />
            )}
        </DialogBody>
    </ModalRoot> :
