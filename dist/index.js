  ...
  const RestoreGameSavesModal = ({ closeModal, serverAPI }) => {
      ...
      return ((progress.status !== '' && progress.percent < 100) ?
          ...
          window.SP_REACT.createElement(deckyFrontendLib.ModalRoot, { style: { width: '600px' } },
              ...
              window.SP_REACT.createElement(deckyFrontendLib.DialogBody, null,
                  window.SP_REACT.createElement(deckyFrontendLib.DialogBodyText, { style: { fontSize: '12px' } }, "This feature will restore all your game save backups at once."),
                  ...
                  window.SP_REACT.createElement(deckyFrontendLib.DialogBodyText, { style: { fontSize: '12px' } }, "Some games don't have local save backups:"),
                  ...
                  window.SP_REACT.createElement(deckyFrontendLib.DialogBodyText, { style: { fontSize: '12px' } }, "Press restore when ready.")),
              window.SP_REACT.createElement(deckyFrontendLib.DialogBody, null,
