  ...
  const RestoreGameSavesModal = ({ closeModal, serverAPI }) => {
      ...
      return ((progress.status !== '' && progress.percent < 100) ?
          ...
          window.SP_REACT.createElement(deckyFrontendLib.ModalRoot, { style: { width: '600px' } },
              ...
              window.SP_REACT.createElement(deckyFrontendLib.DialogBody, null,
                  window.SP_REACT.createElement(deckyFrontendLib.DialogBodyText, { style: { fontSize: '11px' } }, "This feature will restore all your game save backups at once."),
                  window.SP_REACT.createElement(deckyFrontendLib.DialogBodyText, { style: { fontSize: '11px' } },
                      window.SP_REACT.createElement("strong", null, "Ensure all necessary launchers are installed, but do not download the games."),
                      " This will avoid local conflicts. Proceed only if you have wiped everything using Start Fresh and backed up your game saves at /home/deck/NSLGameSaves."),
                  window.SP_REACT.createElement(deckyFrontendLib.DialogBodyText, { style: { fontSize: '11px' } }, "Some games don't have local save backups:"),
                  window.SP_REACT.createElement("ul", null,
                      window.SP_REACT.createElement("li", { style: { fontSize: '11px' } }, "NSL uses Ludusavi to backup and restore your local game saves."),
                      window.SP_REACT.createElement("li", { style: { fontSize: '11px' } }, "Some launchers handle local and cloud saves themselves so this will vary on a game to game basis."),
                      window.SP_REACT.createElement("li", { style: { fontSize: '11px', wordWrap: 'break-word' } }, "Ludusavi may need manual configuration here if more paths are needed: /home/deck/.var/app/com.github.mtkennerly.ludusavi/config/ludusavi/NSLconfig/config.yaml")),
                  window.SP_REACT.createElement(deckyFrontendLib.DialogBodyText, { style: { fontSize: '11px' } }, "Press restore when ready.")),
              window.SP_REACT.createElement(deckyFrontendLib.DialogBody, null,
