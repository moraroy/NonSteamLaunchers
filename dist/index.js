  ...
  */
  ...
  const RestoreGameSavesModal = ({ closeModal, serverAPI }) => {
      ...
      return ((progress.status !== '' && progress.percent < 100) ?
          ...
          window.SP_REACT.createElement(deckyFrontendLib.ModalRoot, { style: { fontSize: '14px', width: '600px' } },
              window.SP_REACT.createElement(deckyFrontendLib.DialogHeader, null, "Restore Game Save Backups"),
              window.SP_REACT.createElement(deckyFrontendLib.DialogBody, { style: { maxHeight: '400px', overflowY: 'auto' } },
                  ...
                  window.SP_REACT.createElement("ul", null,
                      window.SP_REACT.createElement("li", null, "NSL uses a program called Ludusavi to backup your local game saves and will attempt to restore them for you."),
                      ...
                      window.SP_REACT.createElement("li", { style: { wordWrap: 'break-word' } }, "Ludusavi may also not pick up your game saves and may need to be configured manually here: /home/deck/.var/app/com.github.mtkennerly.ludusavi/config/ludusavi/NSLconfig/config.yaml")),
