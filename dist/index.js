  ...
  const RestoreGameSavesModal = ({ closeModal, serverAPI }) => {
      ...
      return ((progress.status !== '' && progress.percent < 100) ?
          ...
          window.SP_REACT.createElement(deckyFrontendLib.ModalRoot, { style: { width: '600px' } },
              ...
              window.SP_REACT.createElement(deckyFrontendLib.DialogBody, null,
                  window.SP_REACT.createElement(deckyFrontendLib.DialogBodyText, { style: { fontSize: '12px' } }, "Restore all your game save backups at once."),
                  window.SP_REACT.createElement(deckyFrontendLib.DialogBodyText, { style: { fontSize: '12px' } },
                      ...
                      " This avoids conflicts. Proceed only if you have wiped everything using Start Fresh and backed up your game saves at /home/deck/NSLGameSaves."),
                  window.SP_REACT.createElement(deckyFrontendLib.DialogBodyText, { style: { fontSize: '12px' } }, "Some games don't have cloud save backups:"),
                  window.SP_REACT.createElement("ul", null,
                      ...
                      window.SP_REACT.createElement("li", { style: { fontSize: '12px' } }, "Some launchers handle local and cloud saves themselves, varying by game."),
                      window.SP_REACT.createElement("li", { style: { fontSize: '12px', wordWrap: 'break-word' } }, "Ludusavi may need manual configuration here: /home/deck/.var/app/com.github.mtkennerly.ludusavi/config/ludusavi/NSLconfig/config.yaml")),
