  ...
  const Content = ({ serverAPI }) => {
      ...
      return (window.SP_REACT.createElement(window.SP_REACT.Fragment, null,
          ...
          window.SP_REACT.createElement(deckyFrontendLib.PanelSection, { title: "Game Launchers" },
              window.SP_REACT.createElement(deckyFrontendLib.PanelSectionRow, { style: { fontSize: "12px", marginBottom: "10px" } }, "Here you choose your launchers you want to install and let NSL do the rest."),
          ...
          window.SP_REACT.createElement(deckyFrontendLib.PanelSection, { title: "Game and Movie Streaming" },
              window.SP_REACT.createElement(deckyFrontendLib.PanelSectionRow, { style: { fontSize: "12px", marginBottom: "10px" } }, "Please install Google Chrome via the Discover Store. NSL uses Chrome to launch these sites."),
