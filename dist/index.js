  ...
  const RestoreGameSavesModal = ({ closeModal, serverAPI }) => {
      ...
      return ((progress.status !== '' && progress.percent < 100) ?
          ...
          window.SP_REACT.createElement(deckyFrontendLib.ModalRoot, { style: { width: '600px' } },
              ...
              window.SP_REACT.createElement(deckyFrontendLib.DialogBody, null,
                  window.SP_REACT.createElement(deckyFrontendLib.DialogBodyText, { style: { fontSize: '10px' } }, "This feature will restore your game save backups all at once."),
                  window.SP_REACT.createElement(deckyFrontendLib.DialogBodyText, { style: { fontSize: '10px' } },
                  ...
                  window.SP_REACT.createElement(deckyFrontendLib.DialogBodyText, { style: { fontSize: '10px' } }, "Some games from their launchers don't have cloud save backups:"),
                  window.SP_REACT.createElement("ul", null,
                      window.SP_REACT.createElement("li", { style: { fontSize: '10px' } }, "NSL uses a program called Ludusavi to backup your local game saves and attempts to restore them for you."),
                      window.SP_REACT.createElement("li", { style: { fontSize: '10px' } }, "However, some games from their launchers won't have local game saves because the launchers themselves take care of the local save and cloud save. This varies on a game-to-game basis."),
                      window.SP_REACT.createElement("li", { style: { fontSize: '10px', wordWrap: 'break-word' } }, "Ludusavi may not pick up your game saves and may need to be configured manually here: /home/deck/.var/app/com.github.mtkennerly.ludusavi/config/ludusavi/NSLconfig/config.yaml")),
                  window.SP_REACT.createElement(deckyFrontendLib.DialogBodyText, { style: { fontSize: '10px' } }, "Once ready, proceed to press restore.")),
              window.SP_REACT.createElement(deckyFrontendLib.DialogBody, null,
